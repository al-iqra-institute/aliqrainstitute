...
const AboutSection = () => {
  return (
    <section className="relative bg-black w-full py-20 flex flex-col items-center">
      {/* Discover Card */}
      <div className="relative z-10 bg-greenCustom border text-white md:pl-16 p-10 md:p-14 md:rounded-[40px] rounded-2xl max-w-5xl shadow-lg -mt-48 md:-mt-44 lg:-mt-56 w-[90%] md:w-[80%] lg:w-[80%]">
        ...
        <Link href={"/about"}>
          <button className="mt-6 px-5 py-2 rounded-xl md:py-4 bg-black text-white md:rounded-2xl text-lg font-semibold flex items-center gap-2 hover:bg-gray-900">
            Discover More
          </button>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16 md:mt-20 max-w-6xl px-6 w-[95%] md:w-[85%] lg:w-[75%]">
        <div className="bg-greenCustom border text-white p-10 md:p-12 rounded-2xl shadow-lg flex flex-col items-center text-center w-full md:w-auto">
          <MapPin size={60} />
          ...
          <Link href={"/courses"}>
            <button className="mt-4 text-black md:text-xl font-semibold flex items-center gap-2 hover:text-gray-900">
              Join Now →
            </button>
          </Link>
        </div>
